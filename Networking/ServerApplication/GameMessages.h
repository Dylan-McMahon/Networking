...
enum GameMessages {
	...
	ID_SERVER_VELOCITY_OBJECT_DATA = ID_USER_PACKET_ENUM + 5,
	ID_CLIENT_UPDATE_OBJECT_POSITION = ID_USER_PACKET_ENUM + 6,
	ID_CLIENT_UPDATE_OBJECT_VELOCITY = ID_USER_PACKET_ENUM + 7,
};